  ...
  return (
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-20 flex flex-col items-center justify-center text-center">
        <div className="mx-auto mb-4 max-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full border border-gray-200 bg-white px-7 py-2 backdrop-blur shadow-md transition-all hover:border-gray-300 hover:bg-white/50">
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          ...
          uplaod your file and start asking questions right away.
        </p>
        <Link
